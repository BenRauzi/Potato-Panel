    ...
    return (
        <>
            <Switch> {/* The Switch decides which component to show based on the current URL.*/}
                ...
                {/* Support */}
                <GuardedRoute exact path='/cases' roles={{ adminLevel: 1 }} component={CasesPage} />
                <GuardedRoute exact path='/case/new' roles={{ adminLevel: 1 }} component={NewCasePage} />
                <GuardedRoute exact path='/case/:id' roles={{ adminLevel: 1 }} component={SingleCasePage} />
